...
/**
 * Производные уведомления интерфейса (ТЗ F.11/U.14).
 * Сервер отдаёт только настройки напоминаний (GET /reminders/settings),
 * ленты предстоящих нет — ближайшие события/задачи и просрочки выводим
 * из уже загруженных сущностей с учётом пользовательских настроек.
 */
